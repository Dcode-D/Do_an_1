...
class BookingHotelItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<EditHotelItemBloc, EditHotelItemState>(
      builder: (context, state) => editHotelBloc.hotel != null
          ? Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          editHotelBloc.hotel != null
                              ? FadeInImage(
                                  ...
                                  image: NetworkImage(
                                      editHotelBloc.hotel != null &&
                                              editHotelBloc.images!.isNotEmpty
                                          ? editHotelBloc.images![0]
                                          : ""),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: Text(
                                  editHotelBloc.hotel != null
                                      ? '${editHotelBloc.hotel!.province!}, ${editHotelBloc.hotel!.city}'
                                      : "loading...",
                                  style: GoogleFonts.roboto(
                                      fontSize: 15,
                      ...
                      Row(
                        children: [
                          Text(
                            editHotelBloc.hotel?.maxPrice != null &&
                                    editHotelBloc.hotel?.minPrice != null
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => BlocProvider<BookerBloc>(
                                            create: (context) => BookerBloc("hotel", editHotelBloc.hotel!.id!)..add(GetBookerEvent()),
                                            child: Builder(
                                              builder: (context) {
