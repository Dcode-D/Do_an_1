...
import 'package:doan1/screens/profile/check_booking/check_user_booking_screen.dart';
            ...
            child: Padding(
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      onTap:(){
                        Navigator.push(context, MaterialPageRoute(builder: (context) =>
                            CheckUserBookingScreen(user: hotelBookingItemBloc.user,)));
                      },
                      child: Row(
                        children: [
                    ...
                    state.rejectSuccess == true || hotelBookingItemBloc.dateBooking!.suspended! == true ?
                    Column(
                      children: [
                        Text(
