                      ...
                      return BlocBuilder<EditTourBloc, EditTourState>(
                        builder: (context, state) {
                          return CheckboxListTile(
                            ...
                            value: context.read<EditTourBloc>().listSelectedTourPlan.map((e) => e.id).contains(context.read<ArticleBloc>().listArticle![index].id),
                            onChanged: (value) {
                              if (value!) {
                                context.read<EditTourBloc>().add(
                                    SetEditTourPlan(tourPlan: [
                                      context.read<ArticleBloc>().listArticle![index]]));
                              } else {
                                context.read<EditTourBloc>().add(
                                    RemoveEditTourPlan(article: context.read<ArticleBloc>().listArticle![index]));
                              }
                            },
                          );
                        },
