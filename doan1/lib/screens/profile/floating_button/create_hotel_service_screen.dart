...
import '../../../BLOC/services_create/hotel/hotel_creation_bloc.dart';
                            ...
                            showDialog(
                                ...
                                Center(
                                  child: ImagePickingDialog(getImageFromGallery: () {
                                    context.read<HotelCreationBloc>().add(HotelCreationImageEvent(
                                        ImageMethod.gallery));
                                  },
                                      getImageFromCamera: () {
                                        context.read<HotelCreationBloc>()
                                            .add(HotelCreationImageEvent(
                                            ImageMethod.camera));
                                      },
                          ...
                          children: [
                            ...
                            SingleChildScrollView(
                              child: Container(
                                ...
                                child: SizedBox(
                                  height: 200,
                                  child: BlocBuilder<HotelCreationBloc, HotelCreationState>(
                                    buildWhen: (previous, current) {
                                      return current is HotelCreationImageState ||
                                          current is HotelCreationInitial;
                                    },
                                    builder: (context, state) {
                                      ...
                                      GridView.builder(
                                        ...
                                        itemCount: context.read<HotelCreationBloc>().listImages.length,
                                        itemBuilder: (BuildContext context, int index) {
                                          return Stack(
                                            children:[
                                              Image.file(
                                                context.read<HotelCreationBloc>().listImages[index],
                                                fit: BoxFit.cover,
                                              ),
                                              Positioned(
                                                top: 0,
                                                ...
                                                child: IconButton(
                                                  onPressed: () {
                                                    context.read<HotelCreationBloc>().add(HotelCreationRemoveImgEvent(index));},
                                                  icon: const Icon(
                                                    Icons.cancel,
                                                    color: Colors.red,
                                                  ),
